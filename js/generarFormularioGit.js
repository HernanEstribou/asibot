function generarFormulario(tipo, numPeriodos) {
    ...
    let datosT3Dai = [
        ...
        {periodo: 202403, csc:86, pa:56, ent2:0, epta:3812 , evalle:8929 ,  eresto:3684},
    ...
    for (let i = 0; i < numPeriodos; i++) {
        html += `
            ...
            <div class="row">
                ...
                <div class="col mb-3">
                    <input class="form-control" id="periodo" type="text" name="periodo" placeholder="AAAAMM" pattern="[0-9]{6}" minlength="6" maxlength="6" title="La fecha debe estar en formato AAAAMM. Ej: 202403" value="${datos[i].periodo}" required>
                </div>`;                
